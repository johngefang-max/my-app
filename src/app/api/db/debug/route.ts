...
function env() {
  ...
  return {
    raw: {
      ...
      NEXT_PUBLIC_SUPABASE_URL: mask(NEXT_PUBLIC_SUPABASE_URL),
      SUPABASE_ANON_KEY: mask(SUPABASE_ANON_KEY),
      NEXT_PUBLIC_SUPABASE_ANON_KEY: mask(NEXT_PUBLIC_SUPABASE_ANON_KEY),
