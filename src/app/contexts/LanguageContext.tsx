...
const translations = {
  zh: {
    ...
    'pricing.pro.yearly': '按年付费 $17.9/月 (9折)',
    'pricing.pro.feature1': '每月50次生成',
    ...
    'pricing.faq.a2': '免费版每月提供5次生成机会，使用基础模型质量和标准渲染速度。生成的模型可以用于个人学习，但不支持商业使用。',
    ...
    'generator.input.text.desc.disabled.edit': '图像编辑需要提供图片',
    'generator.input.text.desc.disabled.imageTo3d': '3D模型生成需要提供参考图片',
    'generator.text.placeholder.edit': '描述你想要的编辑效果...\n\n例如：将背景改为蓝天白云，增加猫咪的高光效果',
    ...
    'generator.warn.nanoBananaTextOnly': 'Nano Banana Pro 只支持文本输入',
    'generator.warn.imageEditRequiresBoth': '图像编辑需要同时提供图片和文本描述',
    ...
    'generator.model.nanoBanana.name': 'Nano Banana Pro',
    'generator.model.nanoBanana.desc': '文本生成高质量图像',
    'generator.model.nanoBananaEdit.name': 'Nano Banana Pro Edit',
    'generator.model.nanoBananaEdit.desc': '图像编辑和增强',
    'generator.model.trellis.name': 'Trellis 3D',
    'generator.model.trellis.desc': '图像转3D模型',
    'generator.preview.toggleTitle': '预览窗口',
    'generator.input.image.desc.edit': '上传图像进行编辑',
    'generator.input.image.desc.imageTo3d': '上传图像转换为3D模型',
    'generator.input.image.desc.disabled': '该模型不支持图像输入',
    'generator.text.title': '描述你的3D模型',
    'generator.image.title': '上传参考图片',
    'generator.preview.imageLabel': '图像',
    'generator.image.remove': '删除图片',
    'generator.settings.headerSuffix': '参数设置',
    'generator.mode.textToImage': '文本转图像',
    'generator.mode.imageEdit': '图像编辑',
    'generator.mode.imageTo3d': '图像转3D',
    'generator.mode.suffix': '模式',
    'generator.params.seed': '随机种子',
    'generator.params.random': '随机',
    'generator.params.seedPlaceholder': '留空为随机',
    'generator.params.syncMode': '同步模式',
    'generator.params.numInferenceSteps': '推理步数',
    'generator.params.guidanceScale': '引导强度',
    'generator.params.imageSize': '图像尺寸',
    'generator.params.width': '宽度',
    'generator.params.height': '高度',
    'generator.params.negativePrompt': '负面提示词',
    'generator.params.negativePromptPlaceholder': '描述不希望出现的内容...',
    'generator.params.numImages': '生成数量',
    'generator.params.strength': '编辑强度',
    'generator.params.scale': '模型缩放',
    'generator.params.numSamples': '样本数量',
    'generator.params.outputFormat': '输出格式',
    'generator.params.simplify': '简化模型',
    'generator.params.textureSize': '纹理大小',
    'generator.params.maxFaces': '最大面数',
    'generator.params.reset': '重置为默认值',
    'generator.cost.label': '生成成本',
    'generator.cost.remaining': '剩余',
    'generator.cost.points': '积分',
    'generator.actions.generating': '生成中...',
    'generator.actions.loginRequired': '请先登录',
    'generator.actions.pointsInsufficient': '积分不足',
    'generator.actions.start': '开始生成',
    'generator.actions.deductionSuffix': '(-3积分)',
    'generator.import.quickTest': '快速测试',
    'generator.import.loadTestGLB': '加载测试GLB模型',
    'generator.import.tipLoadPreset': '点击加载预设的测试模型',
    'generator.import.importedModels': '已导入的模型',
    'generator.import.selected': '已选择',
    'generator.preview.modelTitle': '3D模型预览',
    'generator.preview.imageTitle': '图像预览',
    'generator.preview.defaultTitle': '模型预览',
    'generator.panel.title': '操作面板',
    'generator.actions.downloadModelTitle': '下载3D模型',
    'generator.actions.downloadImageTitle': '下载图像',
  ...
  en: {
    ...
    'pricing.pro.yearly': 'Yearly $17.9/month (10% off)',
    'pricing.pro.feature1': '50 generations per month',
    ...
    'generator.input.text.desc.disabled.edit': 'Image editing requires an image',
    'generator.input.text.desc.disabled.imageTo3d': '3D model generation requires a reference image',
    'generator.text.placeholder.edit': 'Describe the editing effect you want...\n\nFor example: Change the background to blue sky with white clouds, add highlights to the cat',
    ...
    'generator.warn.nanoBananaTextOnly': 'Nano Banana Pro only supports text input',
    'generator.warn.imageEditRequiresBoth': 'Image editing requires both an image and text description',
    ...
    'generator.model.nanoBanana.name': 'Nano Banana Pro',
    'generator.model.nanoBanana.desc': 'High-quality image generation from text',
    'generator.model.nanoBananaEdit.name': 'Nano Banana Pro Edit',
    'generator.model.nanoBananaEdit.desc': 'Image editing and enhancement',
    'generator.model.trellis.name': 'Trellis 3D',
    'generator.model.trellis.desc': 'Convert image to 3D model',
    'generator.preview.toggleTitle': 'Preview Panel',
    'generator.input.image.desc.edit': 'Upload an image to edit',
    'generator.input.image.desc.imageTo3d': 'Upload an image to convert to 3D',
    'generator.input.image.desc.disabled': 'This model does not support image input',
    'generator.text.title': 'Describe Your 3D Model',
    'generator.image.title': 'Upload Reference Images',
    'generator.preview.imageLabel': 'Image',
    'generator.image.remove': 'Remove image',
    'generator.settings.headerSuffix': 'Settings',
    'generator.mode.textToImage': 'Text to Image',
    'generator.mode.imageEdit': 'Image Edit',
    'generator.mode.imageTo3d': 'Image to 3D',
    'generator.mode.suffix': 'Mode',
    'generator.params.seed': 'Seed',
    'generator.params.random': 'Random',
    'generator.params.seedPlaceholder': 'Leave empty for random',
    'generator.params.syncMode': 'Sync Mode',
    'generator.params.numInferenceSteps': 'Inference Steps',
    'generator.params.guidanceScale': 'Guidance Scale',
    'generator.params.imageSize': 'Image Size',
    'generator.params.width': 'Width',
    'generator.params.height': 'Height',
    'generator.params.negativePrompt': 'Negative Prompt',
    'generator.params.negativePromptPlaceholder': 'Describe what you don\'t want to see...',
    'generator.params.numImages': 'Number of Images',
    'generator.params.strength': 'Edit Strength',
    'generator.params.scale': 'Model Scale',
    'generator.params.numSamples': 'Number of Samples',
    'generator.params.outputFormat': 'Output Format',
    'generator.params.simplify': 'Simplify Mesh',
    'generator.params.textureSize': 'Texture Size',
    'generator.params.maxFaces': 'Max Faces',
    'generator.params.reset': 'Reset to Defaults',
    'generator.cost.label': 'Generation Cost',
    'generator.cost.remaining': 'Remaining',
    'generator.cost.points': 'points',
    'generator.actions.generating': 'Generating...',
    'generator.actions.loginRequired': 'Please log in first',
    'generator.actions.pointsInsufficient': 'Insufficient points',
    'generator.actions.start': 'Start Generation',
    'generator.actions.deductionSuffix': '(-3 points)',
    'generator.import.quickTest': 'Quick Test',
    'generator.import.loadTestGLB': 'Load Test GLB',
    'generator.import.tipLoadPreset': 'Click to load a preset test model',
    'generator.import.importedModels': 'Imported Models',
    'generator.import.selected': 'Selected',
    'generator.preview.modelTitle': '3D Preview',
    'generator.preview.imageTitle': 'Image Preview',
    'generator.preview.defaultTitle': 'Preview',
    'generator.panel.title': 'Actions',
    'generator.actions.downloadModelTitle': 'Download 3D Model',
    'generator.actions.downloadImageTitle': 'Download Image',
