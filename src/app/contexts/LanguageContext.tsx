...
const translations = {
  zh: {
    ...
    'home.testimonials.title': '深受创作者喜爱',
    'home.testimonials.subtitle': '团队与独立创作者用 AI3D Pro 更快交付',
    'home.testimonials.quote1': '把原型从几个小时缩到几分钟，正是我工作流需要的。',
    'home.testimonials.name1': 'Maya Thompson',
    'home.testimonials.role1': '资深 3D 艺术家 · StudioX',
    'home.testimonials.quote2': '提示词→可玩素材。我每周做独立游戏冲刺都在用。',
    'home.testimonials.name2': 'Alex Rivera',
    'home.testimonials.role2': '独立游戏开发者',
    'home.testimonials.quote3': '非常适合快速概念模型，导出直接丢进 Unreal。',
    'home.testimonials.name3': 'Priya Nair',
    'home.testimonials.role3': '技术美术',
